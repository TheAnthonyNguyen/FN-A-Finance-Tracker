...
<?php
echo "<h1> Savings Statement Information </h1>";
...
if (isset($_COOKIE['username'])) {
    ...
    $sql = "select *, 'INCOME' as type from INCOME where account_number='$account_number' and income_designation='savings' union select *, 'EXPENSE' as type from EXPENSES where account_number='$account_number' and expense_designation='savings'";
